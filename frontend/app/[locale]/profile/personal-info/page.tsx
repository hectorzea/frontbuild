  ...
  return (
    <>
      <div>
        ...
        <h3 className="pb-2 text-muted-foreground">
          Hector Alejandro Zea Sanchez
        </h3>
      </div>
      <div>
      ...
      <div>
        <h3 className="text-2xl font-semibold">Nationality</h3>
        <h3 className="pb-2 text-muted-foreground">Argentina</h3>
      </div>
      <div>
        <h3 className="text-2xl font-semibold">Current Address</h3>
      ...
      <div>
        ...
        <ul className="max-w-md space-y-1 text-gray-500 list-disc list-inside dark:text-gray-400">
          <li>
            <a
              data-testid="linkedin-navigation-link"
              className={
          ...
          <li>
            <a
              data-testid="github-navigation-link"
              className={
                "font-medium text-blue-600 dark:text-blue-500 hover:underline"
              }
              rel="noreferrer"
