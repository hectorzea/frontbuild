    ...
    <div>
      <div className="flex flex-col sm:flex-row gap-10 mt-0 sm:mt-10">
        <div className="flex flex-col items-center max-w-xs sm:max-w-md space-y-4">
          ...
          <p className="text-center max-w-xs sm:max-w-md">
            I am a highly adaptable problem-solver with a strong technical
            skillset, capable of quickly learning and contributing in new
            environments.
          </p>
        </div>
        <div className="flex flex-col items-center max-w-xs sm:max-w-md space-y-4">
          ...
          <p className="text-center max-w-xs sm:max-w-md">
            I&apos;m always curious to understand and learn new things, i like
            to code and to build things working in team
          </p>
        </div>
        <div className="flex flex-col items-center max-w-xs sm:max-w-md space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-10 mt-10 sm:mt-0 sm:mt-20">
        <div className="flex flex-col items-center max-w-xs sm:max-w-md space-y-4">
          ...
          <p className="text-center max-w-xs sm:max-w-md">
            I enjoy researching all aspects of testing and frontend best
            practices.
          </p>
        </div>
        <div className="flex flex-col items-center max-w-xs sm:max-w-md space-y-4">
          ...
          <p className="text-center max-w-xs sm:max-w-md">
            I am passionate about working hard and giving my best to help the
            team succeed.
          </p>
        </div>
        <div className="flex flex-col items-center max-w-xs sm:max-w-md space-y-4">
          ...
          <p className="text-center max-w-xs sm:max-w-md">
            I like to help to solve any frontend problems that may appear in the
            daily basis.
          </p>
        </div>
      </div>
