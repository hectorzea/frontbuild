  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        "tech-debt":
          "border-transparent bg-gray-600 text-gray-600-foreground shadow hover:bg-gray-400",
        feature:
          "border-transparent bg-cyan-600 text-cyan-600-foreground shadow hover:bg-cyan-400",
